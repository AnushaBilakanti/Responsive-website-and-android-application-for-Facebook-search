...
public class favuserTab extends Fragment {
    ListView listView;
    ImageView imageView;
    TextView mTextView;
                             ...
                             @Nullable Bundle savedInstanceState)
    {
        ...
        SharedPreferences sharedPrefUser=getActivity().getSharedPreferences("userdetails", Context.MODE_PRIVATE);
        ...
        String url="";
        String id="";
        Map<String,?> keys = sharedPrefUser.getAll();
        ...
        FavListAdapter adapter = new FavListAdapter(usersData,getContext(),"user");
