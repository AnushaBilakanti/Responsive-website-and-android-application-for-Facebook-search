...
public class faveventTab extends Fragment
{
    ListView listView;
                             ...
                             @Nullable Bundle savedInstanceState)
    {
        ...
        SharedPreferences sharedPrefEvent=getActivity().getSharedPreferences("eventdetails", Context.MODE_PRIVATE);
        ...
        String url="";
        String id="";
        Map<String,?> keys = sharedPrefEvent.getAll();
        ...
        FavListAdapter adapter = new FavListAdapter(eventData,getContext(),"event");
