...
public class FavListAdapter extends BaseAdapter
{
    ...
    public FavListAdapter(List<ResultsData> mData, Context context,String type)
    {
        this.mData = mData;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            row = inflater.inflate(R.layout.list_item_fav,parent,false);
        }
        ImageView imageView = (ImageView)row.findViewById(R.id.image_in_list1);
        TextView mTextView = (TextView)row.findViewById(R.id.text_list_view1);
        ImageButton imageButton = (ImageButton)row.findViewById(R.id.next_image1);
